...
<!-- REQUIRED: what you changed and why you expected a lower (faster) SCORE. CI copies this into history/entries/. -->
...
- [ ] **`## Model`** filled in
- [ ] Local SCORE **beats** the current record (lower wall-clock ns is better)
- [ ] **Verify PR** passes → auto-merges → **Scorekeeper** records the ledger

## Local score (informational)

<!-- Optional: paste evaluate output. The reference-runner CI score is authoritative. -->
